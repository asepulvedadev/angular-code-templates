...
Please analyze the existing templates in the repository first to understand the structure and patterns, then create the new template following the same conventions.</pre>
                    ...
                    <div class="contribute-footer">
                        <div class="help-section">
                            <h4>Need Help?</h4>
                            <p>Check out <a href="https://github.com/asepulvedadev/angular-code-templates/blob/main/CONTRIBUTING.md" target="_blank">CONTRIBUTING.md</a> or open an issue on GitHub.</p>
                        </div>
                    </div>
                </div>
            </div>
...
function getGithubFolderUrl(languageKey, frameworkKey) {
    const baseUrl = 'https://github.com/asepulvedadev/angular-code-templates/tree/main/cli-tool/templates';
...
function getGithubFileUrl(languageKey, frameworkKey, filePath) {
    const baseUrl = 'https://github.com/asepulvedadev/angular-code-templates/blob/main/cli-tool/templates';
